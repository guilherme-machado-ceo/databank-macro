...
CAMPO_CLIMA = CampoConfig(
    ...
    conecta_com=[CampoGranular.INFRAESTRUTURA, CampoGranular.TERRAS_RARAS],
    vetores={
...
CAMPO_TERRAS_RARAS = CampoConfig(
    ...
    modo=ModoCampo.PARALELO,
    conecta_com=[CampoGranular.CHIPS, CampoGranular.INFRAESTRUTURA, CampoGranular.CLIMA],
    vetores={
        ...
        "geopolitical_risk_idx": VetorConfig("geopolitical_risk_idx", "Risco geopolitico", "indice", "FRED", "mensal", 0.06, CampoGranular.TERRAS_RARAS, 0.04),
        "btc_usd": VetorConfig("btc_usd", "Bitcoin", "USD", "CoinGecko", "diario", 0.05, CampoGranular.TERRAS_RARAS, 0.04),
        "conflitos_ativos": VetorConfig("conflitos_ativos", "Conflitos ativos", "numero", "ACLED", "mensal", 0.04, CampoGranular.TERRAS_RARAS, 0.04),
...
MAPA_CASCATA = {
    CampoGranular.TERRAS_RARAS: [CampoGranular.CHIPS, CampoGranular.INFRAESTRUTURA],
    CampoGranular.CHIPS: [CampoGranular.INFRAESTRUTURA, CampoGranular.TERRAS_RARAS],
    CampoGranular.CLIMA: [CampoGranular.INFRAESTRUTURA, CampoGranular.TERRAS_RARAS],
    CampoGranular.INFRAESTRUTURA: [CampoGranular.CHIPS, CampoGranular.TERRAS_RARAS],
}
...
def get_sensibilidade(campo: CampoGranular) -> float:
    return {CampoGranular.CLIMA: 0.05, CampoGranular.INFRAESTRUTURA: 0.03,
            CampoGranular.CHIPS: 0.07, CampoGranular.TERRAS_RARAS: 0.04}.get(campo, 0.05)
